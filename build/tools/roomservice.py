...
custom_local_manifest = ".repo/local_manifests/naap_manifest.xml"
custom_default_revision = "fourteen"
custom_dependencies = "naap.dependencies"
org_manifest = "naap"  # leave empty if org is provided in manifest
org_display = "NAAP"  # needed for displaying
